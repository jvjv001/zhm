    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">DataLearn</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/dashboard" className="text-gray-400 hover:text-white">仪表盘</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">地址: 北京市海淀区中关村</li>
            </ul>
          </div>
          <div>
